...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "johnm04-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/johnm"
  #   chef.validation_client_name = "johnm-validator"
  #   chef.validation_key_path = ".chef/johnm-validator.pem"
  # end
end
